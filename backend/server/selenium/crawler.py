...
driver.get(unquote("https://webapp.itsc.cuhk.edu.hk/ras/restricted/event?id=42901"))

# login
element = driver.find_element_by_xpath('//*[@id="userNameInput"]')
element.send_keys("1155102444@link.cuhk.edu.hk")
password = driver.find_element_by_xpath('//*[@id="passwordInput"]')
password.send_keys("5165emmil!@#")
...
data = {
    'title' : title,
    'desc' : "\n".join(body_array[1:date_index+2]),
